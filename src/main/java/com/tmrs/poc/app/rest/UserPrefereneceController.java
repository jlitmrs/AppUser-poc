...
import com.tmrs.poc.app.service.UserPreferenceService;
...
public class UserPrefereneceController {
	...
	@Operation(
		summary = "Create new UserPreference for a AppUser",
	    description = "Create new UserPreference for a AppUser.")
	@ApiResponses({

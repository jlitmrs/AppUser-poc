...
public class ApplicationHistory {
	...
	@Column(name="column_name", length=60, nullable=false, columnDefinition="VARCHAR(60)")
	...
	@Column(name="new_value", length=12, columnDefinition="VARCHAR(256)")
	private String newValue;
	
	@Column(name="change_user", length=12, columnDefinition="VARCHAR(16)")
	...
	public ApplicationHistory(String tableName, String columnName, Long recordId, ChangeType changeType, String newValue, String oldValue, String changeUser) {

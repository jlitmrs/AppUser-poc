...
import com.tmrs.poc.nextgen.exception.LoginException;
import com.tmrs.poc.nextgen.jpa.entity.NextGenUser;
import com.tmrs.poc.nextgen.jpa.entity.SecurityPermission;
import com.tmrs.poc.nextgen.jpa.entity.UserPreference;
import com.tmrs.poc.nextgen.model.LoginModel;
import com.tmrs.poc.nextgen.model.LoginUserModel;
...
public class LoginController {
	...
	@Operation(
			summary = "Login to Application NextGenPoc",
			description = "Login to Application NextGenPoc.")
	@ApiResponses({
	...
	public ResponseEntity<LoginUserModel> login(@Valid @RequestBody LoginModel model) {
		if(nextGenUserService.userNameExists(model.getUsername())) {
			NextGenUser user = nextGenUserService.getByUserName(model.getUsername());
	...
	@Operation(
			summary = "Log off Application NextGenPoc",
			description = "Log off Application NextGenPoc.")
	@ApiResponses({
	...
	public ResponseEntity<String> logout(@RequestHeader("userName") String userName) {
		if(nextGenUserService.userNameExists(userName)) {

package com.tmrs.poc.app.testListener;
...
public class AppTestListener implements TestExecutionListener, Ordered  {
	
	
	private static final Logger logger = LogManager.getLogger(AppTestListener.class);
